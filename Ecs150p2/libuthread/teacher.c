...
static ucontext_t origContext1;
/*
...
//context_switch(1, 0);
swapcontext(&ctx[1],&origContext1);
...
makecontext(&ctx[1], (func_t)f1, 1, 23);
/*
...
makecontext(&ctx[2], (func_t)f2, 1, 42);
...
swapcontext(&origContext1,&ctx[2]);
//context_switch(0, 2);
